  ...
  return (
    <Link href="/productsells">
      ...
      >
        ...
        <section className="relative bg-[#1a1918] py-8 text-white border-b-4 border-[#d4af37]">
        ...
        <section className="py-8 bg-[#1a1918]">
          <div className="container mx-auto px-6 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="bg-[#e2e2e2] p-6 rounded-xl border-r-4 border-[#d4af37] flex items-center gap-4"
                >
        ...
        <section className="py-12 bg-[#ffffff]">
          <div className="container mx-auto px-6 text-center">
            ...
            />
            <p className="text-xl text-gray-900 mb-12 max-w-3xl mx-auto leading-loose font-bold">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 text-right ">
              {[
                ...
                <div
                  key={i}
                  className="bg-[#e2e2e2] p-6 rounded-xl border-r-4 border-[#d4af37]"
                >
        ...
        <section className="py-4 bg-[#1a1918] relative overflow-hidden">
          <div className="container mx-auto px-6 text-center relative z-10">
            <h2 className="text-4xl font-black mb-8 text-gray-200 leading-snug">
